...
class EditActorDialog: DialogFragment() {
    ...
    override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {
        ...
        val actor: String = arguments?.getString(getString(R.string.actor)).toString()
            ...
            when {
                ...
                colorRadioGroup.checkedRadioButtonId == View.NO_ID -> {
                    ...
                    this.listener?.onClickEditActor(
                        actor, nameEditText.text.toString(), onRadioButtonClicked(), getString(R.string.shape_actor))
                    dismiss()
                }
            }
        }
